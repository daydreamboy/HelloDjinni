...
class NativeHelloWorld final : ::djinni::JniInterface<::HelloDjinni::HelloWorld, NativeHelloWorld> {
public:
...
private:
    ...
    friend ::djinni::JniInterface<::HelloDjinni::HelloWorld, NativeHelloWorld>;
